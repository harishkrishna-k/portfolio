# Harish Krishna K
Hosur, Tamil Nadu | +91 7598250291 | harishkrishna.k@outlook.com
[LinkedIn](https://linkedin.com/in/harishkrishnak) | [GitHub](https://github.com/harishkrishna-k) | [Portfolio](https://harishkrishna.in)

## Professional Summary
Mechanical Engineering graduate with hands-on experience designing, instrumenting, and validating physical systems. Skilled in translating engineering requirements into testable hardware solutions through rapid prototyping, sensor integration, experimental validation, and system-level problem solving. Experienced in building custom test infrastructure and applying first-principles engineering to real-world hardware challenges, supported by strong scripting and automation capabilities to accelerate integration and deployment.

## Technical Skills
- **Mechanical Design & CAD:** CAD Drafting, Technical Drawing, Rapid Prototyping (3D Printing), Reverse Engineering, Design for Manufacturing (DFM)
- **Systems Engineering & Validation:** System Identification, Instrumentation, Experimental Validation, Design of Experiments (DOE), Thermal Analysis, Root Cause Analysis
- **Automation & Integration:** Sensor Data Acquisition, Microcontroller Integration (Arduino/ESP), Python, GenAI APIs, Workflow Automation (n8n)
- **Operations & Deployment:** Process Bottleneck Resolution, Lean / Six Sigma, Cross-Functional Coordination

## Hardware & Engineering Projects
### Design, Instrumentation & Validation of Experimental Thermal Test Rig (02/2022 – 06/2022)
...
### Embedded Battery Monitoring and Thermal Protection System (02/2023 – 05/2023)
- Monitored voltage, current, and thermal parameters across a custom-built 12V 18650 Lithium-Ion battery pack using integrated sensing (LM35, ACS712) and data acquisition systems. [Live Dashboard](https://harishkrishna-k.github.io/Li-ion_PMS/demo-dashboard/)
...
### ESP-Based Sensor Acquisition and Control Platform (Personal Lab) (Ongoing)
...
### Shriram Finance Limited - Management Trainee (Operations & Coordination) (11/2023 – 08/2024)
...
## Education
- **Anna University, Trichy** - Bachelor of Engineering (B.E.), Mechanical Engineering (08/2019 – 06/2023)
